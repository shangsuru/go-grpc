...
var file_calculator_calculator_proto_rawDesc = []byte{
	...
	,
...
var file_calculator_calculator_proto_depIdxs = []int32{
	0, // 0: CalculatorService.Calculator:input_type -> Summands
	1, // 1: CalculatorService.Calculator:output_type -> Sum
...
type CalculatorServiceClient interface {
	Calculator(ctx context.Context, in *Summands, opts ...grpc.CallOption) (*Sum, error)
}
...
func (c *calculatorServiceClient) Calculator(ctx context.Context, in *Summands, opts ...grpc.CallOption) (*Sum, error) {
	out := new(Sum)
	err := c.cc.Invoke(ctx, "/CalculatorService/Calculator", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculatorServiceServer interface {
	Calculator(context.Context, *Summands) (*Sum, error)
}
...
func (*UnimplementedCalculatorServiceServer) Calculator(context.Context, *Summands) (*Sum, error) {
...
func _CalculatorService_Calculator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/CalculatorService/Calculator",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServiceServer).Calculator(ctx, req.(*Summands))
	}
